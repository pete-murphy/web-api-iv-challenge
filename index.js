...
(function($PS) {
  ...
  var lookupPort = function __do() {
      ...
      return Data_Maybe.maybe(4321)(function ($5) {
          return Data_Maybe.fromMaybe(1234)(Data_Int.fromString($5));
      })(v);
  };
  var main = function __do() {
      var v = lookupPort();
      return HTTPure_Server.serve(v)(function (v1) {
          return HTTPure_Response.ok(HTTPure_Body.bodyString)("hello world");
      })(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Heoll"))();
  };

...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];                 
  var port = 8080;
  var main = HTTPure_Server.serve(port)(Data_Function["const"](HTTPure_Response.ok(HTTPure_Body.bodyString)("hello world!")))(Effect_Console.log("Hello! Server running on port " + Data_Show.show(Data_Show.showInt)(port)));
  exports["port"] = port;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();